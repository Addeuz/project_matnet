...
const EditDirectCurrent = ({ engine }) => {
  ...
  React.useEffect(() => {
    ...
    setInitialFields({
      ...
      magnetiseringV: engine.engineInfo.magnetiseringV,
      magnetiseringA: engine.engineInfo.magnetiseringA,
      ohm: engine.engineInfo.ohm,
    ...
    setInitialCheckboxes({
      ...
      kommutatorYta: engine.engineValues.kommutatorYta,
      kollektorTemp: engine.engineValues.kollektorTemp,
          ...
          .put(
            `http://localhost:3000/api/moderator/engine/${engine.engineId}`,
            {
              engineInfo: {
                ...
                ström: values['ström'],
                magnetiseringV: values.magnetiseringV,
                magnetiseringA: values.magnetiseringA,
                ohm: values.ohm,
...
export default EditDirectCurrent;
