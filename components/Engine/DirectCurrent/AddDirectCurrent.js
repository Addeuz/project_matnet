...
const AddDirectCurrent = ({ engineType }) => {
              ...
              <SFormGroup as={Row}>
                ...
                <SCol sm={7}>
                  <Form.Control
                    ...
                    isInvalid={touched.ohm && errors.ohm}
                  />
                  {/* <Form.Control.Feedback tooltip="true" type="invalid">
                    {errors.strom}
                  </Form.Control.Feedback> */}
            ...
            <Col md={6}>
              <SFormGroup as={Row}>
                <Col xs={6}>
                  ...
                  />
                  <Form.Check
                    id="engineMeasureData.kommutatorYta"
                    className="custom-form-check-input"
                    type="checkbox"
                  ...
                  <Form.Check
                    id="engineMeasureData.kollektorTemp"
                    className="custom-form-check-input"
                    type="checkbox"
...
export default AddDirectCurrent;
