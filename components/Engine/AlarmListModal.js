...
import AlarmList, { InfoText } from '../AlarmList';
...
const AlarmListModal = ({ show, onHide, alarmData, clientName }) => {
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>Larmlista för {clientName}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {/* <Formik
